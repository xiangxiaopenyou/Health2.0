//
//  ClubDiscussionCommentTableViewCell.m
//  Health
//
...
@implementation ClubDiscussionCommentTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier withData:(NSDictionary *)dic{
    ...
    if (self) {
        ...
        //昵称
        nicknameLabel = [[UILabel alloc] initWithFrame:CGRectMake(61, 16, 160, 20)];
        ...
        if ([[dic objectForKey:@"type"] integerValue] == 2) {
            ...
            CGSize nicknameSize = [nicknameString sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:SMALLFONT_13, NSFontAttributeName, nil]];
            ...
            CGSize contentSize = [contentString sizeWithFont:SMALLFONT_13 constrainedToSize:CGSizeMake(SCREEN_WIDTH - 61 - 14, MAXFLOAT) lineBreakMode:NSLineBreakByCharWrapping];
            contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(61, 45, contentSize.width, contentSize.height)];
            contentLabel.text = contentString;
            contentLabel.textColor = [UIColor colorWithRed:227/255.0 green:227/255.0 blue:227/255.0 alpha:1.0];
            contentLabel.font = SMALLFONT_13;
            contentLabel.textAlignment = NSTextAlignmentLeft;
            contentLabel.numberOfLines = 0;
            contentLabel.lineBreakMode = NSLineBreakByCharWrapping;
            [self addSubview:contentLabel];
