...
@interface SelectedFoodViewController ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)setupTipView{
    ...
    sportsCountLabel.text = [NSString stringWithFormat:@"%lu", (unsigned long)self.foodArray.count];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *dic = [self.foodArray objectAtIndex:indexPath.row];
    cell.textLabel.text = [dic objectForKey:@"foodname"];
    cell.textLabel.textColor = [UIColor whiteColor];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@大卡/100克", [dic objectForKey:@"foodperenergy"]];
    ...
    enLabel.text = [NSString stringWithFormat:@"%@大卡", [dic objectForKey:@"foodenergy"]];
    ...
    timeLabel.text = [NSString stringWithFormat:@"%@克", [dic objectForKey:@"selectedweight"]];
