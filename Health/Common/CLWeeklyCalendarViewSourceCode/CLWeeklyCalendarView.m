...
#define DAY_TITLE_VIEW_HEIGHT 14.f
#define DAY_TITLE_FONT_SIZE 10.f
#define DATE_TITLE_MARGIN_TOP 7.f

#define DATE_VIEW_MARGIN 2.f
#define DATE_VIEW_HEIGHT 22.f
...
//static NSString* const CLCalendarSelectedDatePrintFormatDefault = @"d MMM yyyy";
...
-(void)applyCustomDefaults
{
    ...
    //self.weekStartConfig = [NSNumber numberWithInt:[self.weekStartConfig integerValue] - 2];
...
-(UIImageView *)backgroundImageView
{
    ...
    _backgroundImageView.backgroundColor = [UIColor colorWithRed:230/255.0 green:187/255.0 blue:13/255.0 alpha:1.0];
...
-(UILabel *)dayTitleViewForDate: (NSDate *)date inFrame: (CGRect)frame
{
    ...
    dayTitleLabel.text = [arrWeek objectAtIndex:week - 1];
    dayTitleLabel.textAlignment = NSTextAlignmentCenter;
    dayTitleLabel.font = SMALLFONT_10;
